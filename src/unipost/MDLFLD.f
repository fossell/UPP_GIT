...
!    
      ...
      use vrbls3d, only: zmid, t, pmid, q, cwm, f_ice, f_rain, f_rimef,&
              qqw, qqi,qqr, qqs, cfr, dbz, dbzr, dbzi,dbzc, qqw, nlice,&
              qqg, zint, qqni,qqnr, uh, vh, mcvg, omga, wh, q2, ttnd, &
              rswtt, rlwtt, train, tcucn,o3, rhomid, dpres, el_pbl, &
              pint, icing_gfip 
      use vrbls2d, only: slp, hbot, htop, cnvcfr, cprate, cnvcfr, &
              echotop, vil,radarvil, sr, prec, vis, czen, pblh, &
              u10, v10, avgprec, avgcprate
      use masks, only: lmh, gdlat, gdlon
      use params_mod, only: rd, gi, g, rog, h1, tfrz, d00, dbzmin, &
              d608, small,h100, h1m12, h99999
      use pmicrph_mod, only: r1, const1r, qr0, delqr0, const2r, ron, &
              topr, son,tops, dsnow, drain,const_ng1,const_ng2, gon, &
              topg, dgraupel
      use ctlblk_mod, only: jsta_2l, jend_2u, lm, jsta, jend, grib, &
              cfld, datapd,fld_info, modelname, imp_physics,dtq2, &
              spval, icount_calmict,me, dt, avrain, theat, ifhr, &
              ifmin, avcnvc, lp1, im, jm 
