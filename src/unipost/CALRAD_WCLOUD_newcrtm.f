...
505     format('iget(igate=',I0,') = ',I0,' > 0 so MTSAT 2 or 1r selected')
  ...
  ifactive: if (iget(327) > 0 .or. iget(328) > 0 .or. iget(329) > 0       &
       ...
       .or. iget(807) > 0 .or. iget(809) > 0 .or. iget(810) > 0  &
       .or. iget(910) > 0 .or. iget(911) > 0 .or. iget(912) > 0  &
       .or. iget(913) > 0 .or. iget(914) > 0 .or. iget(915) > 0  &
 ...
 3302                           format('Sample tb(',I0,',',I0,',',I0,') in CALRAD = ',F0.3)
              ...
              if(isis=='ssmis_f17') then ! writing f17 ssmis to grib
                 do ixchan=3,6
                    ichan=2+ixchan ! using select_channels, we discard channels 1-11, 14 and 19-24
                    igot=iget(797+ixchan) ! iget(800) ... iget(803)
                    if(igot > 0) then
                       do j=jsta,jend
                          do i=1,im
                             grid1(i,j)=tb(i,j,ichan)
