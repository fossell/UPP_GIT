!
!-- For the new version of the microphysics:
!
...
!     RAIN, AND SNOW.  THE CODE IS BASED ON OPTION MP_PHYSICS==5 or 85 IN 
!     THE WRF NAMELIST AND OPTION MICRO='fer_hires' in NMMB CONFIGURE FILES.
!     
! PROGRAM HISTORY LOG:
!   01-08-14  YI JIN 
...
!
      ...
      use cmassi_mod, only: t_ice, rqr_drmin, n0rmin, cn0r_dmrmin, mdrmin, rqr_drmax,&
              cn0r_dmrmax, mdrmax, n0r0, xmrmin, xmrmax, massi, cn0r0, mdimin,&
              xmimax, mdimax
!- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
      implicit none
!
